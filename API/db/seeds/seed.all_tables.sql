...
INSERT INTO orders (email, address, state, product_skus_and_quantity, amount_cents, checkout_session_id, UUID)
VALUES
	('user@test.com', '123 Address Lane', 'OK', '{{ATC-OK-Beanie-S-GREEN, 1}, {ATC-OK-Beanie-M-DKBL, 3}, {ATC-OK-DadHat-XS, 5}}', 7900, 1, 'a6b14dc5-8102-4d14-8d43-73bf16118eec'),
	('demo@email.com', '123 Address Lane', 'MN', '{{ATC-OK-DadHat-XS, 3}, {MSCM-Hoodie-XS, 4}, {ATC-OK-Tee-XS, 5}}', 8200, 2, '8f3a2cd3-3fc5-42e3-8ca8-c235e034e3a8');
