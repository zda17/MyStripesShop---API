...
INSERT INTO products (sku, name, category, description, gender, photo_url, created_at, updated_at, price_cents, size, color, quantity_available)
VALUES
